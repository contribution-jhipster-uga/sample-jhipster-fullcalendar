...
import { CalendarEventDeleteDialogComponent } from 'app/entities/calendar-event/calendar-event-delete-dialog.component';
  ...
  describe('CalendarEvent Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CalendarEventDeleteDialogComponent]
      })
