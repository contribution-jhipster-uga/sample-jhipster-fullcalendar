...
import { CalendarEventComponent } from 'app/entities/calendar-event/calendar-event.component';
...
describe('Component Tests', () => {
  describe('CalendarEvent Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.calendarEvents && comp.calendarEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
